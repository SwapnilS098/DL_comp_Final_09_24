...
def preprocess_gray(image_path):
    """
    Function to convert the image into the grayscale version of 3channels
...
def save_compressed_image(output, save_path):
    ...
    output_image.save(save_path,"WEBP")
...
def run_inference(image_path, model_path, save_path):
    ...
    print("Time in seconds for the RGB image inference is:",round(end-start,2),"seconds")
...
#paths for the image and the model and the exports
